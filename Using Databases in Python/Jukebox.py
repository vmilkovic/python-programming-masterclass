...
class DataListBox(Scrollbox):
    ...
    def requery(self, link_value=None):
        self.link_value = link_value  # store the id, so we know the "master" record we're populated form
    ...
    def on_select(self, event):
        if self.linked_box:
            ...
            value = self.get(index),  # , because its a tuple and we need to get only the first value
