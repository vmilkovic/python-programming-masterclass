...
# with the keys being the numbers of the locations that the values begin
# dictionaries holding the exit (as they do a present). No change should
# be needed to the actual code.
#
# One that is working, create another dictionary that contains words that
