class Song:
    ...
    Challenge:
        Modify the program so that the class structure matches the simplified diagram: Artist object can hold
        references to Album objects, and Album object can hold references to Song object
    ...
    name = property(get_title)  # Add property so we don't need to change every .name in code to .title
    ...
    def add_song(self, song, position=None):
        ...
        Args:
            ...
            position (Optional[int]): If specified, the song will be added to that position in the track list
                ...
                Otherwise, the song will be added to the ond of the list.
        """
...
class Artist:
    ...
    def add_song(self, name, year, title):
        ...
        This method will add the son to an album in collection.
        A new album will be created in the collection if it doesn't alredy exist.
